                                ...
                                <div className="flex items-center justify-between mb-3 pb-2 border-b" style={{ borderBottomColor: 'var(--border-color)' }}>
                                  ...
                                  {route.service === 'http_status:404' ? (
                                    ...
                                    <button
                                      ...
                                      className="w-9 h-9 flex items-center justify-center rounded bg-red-500/15 border border-red-500/30 text-red-400 hover:bg-red-500/25 hover:border-red-500 transition-all"
                                      title="Remove Route"
                                    >
